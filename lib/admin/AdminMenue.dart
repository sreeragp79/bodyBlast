...
class Adminmenue extends StatefulWidget {
  const Adminmenue({super.key});

  @override
  State<Adminmenue> createState() => _ProfileState();
}

class _ProfileState extends State<Adminmenue> {
  @override
                                ...
                                children: [
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      ...
                                      appbarText("Admin Menus",width/14.84),
                                      Container(
                                        width: width/5.50,
                                        height: height/20.45,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        profileTexts("Users Locations", (){
                                          prologValue.getUserInfoForLocation(context);
                                          callNext(context, Userslocation());}),
